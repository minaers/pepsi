    ...
    <table class="table table-striped">
        ...
        <?php $__currentLoopData = $users_event; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <?php else: ?>
                <td>host ID : <?php echo e($event['host']); ?>   Host Name :
                    <?php echo e($results = DB::table('users_event')
                    ->where('id',$event['host'])
                ...
                <td><a href="<?php echo e(action('UsersController@edit', $event['id'])); ?>" class="btn btn-success">Approve</a></td>
